...
class InputPinTransfer extends StatefulWidget {
  ...
  @override
  State<InputPinTransfer> createState() => _InputPinTransferState();
}

class _InputPinTransferState extends State<InputPinTransfer> {
